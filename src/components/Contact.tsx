    ...
    <section id="contact" className="py-20 bg-background">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
          {contactMethods.map((method, index) => (
            <a
              key={index}
              href={method.href}
              className="bg-card p-6 rounded-lg shadow-soft border border-border/50 hover:shadow-warm hover:border-terracotta/30 transition-all duration-300 group block"
            >
              <div className="flex items-center mb-4">
                <div className="w-10 h-10 bg-gradient-sunset rounded-lg flex items-center justify-center mr-4 group-hover:scale-110 transition-transform duration-300">
                  <div className="text-primary-foreground">
                    {method.icon}
                  </div>
                </div>
                <div>
                  <h3 className="font-semibold text-primary group-hover:text-terracotta transition-colors duration-300">
                    {method.label}
                  </h3>
        ...
        <div className="bg-gradient-warm p-8 md:p-12 rounded-2xl border border-border/50 text-center">
          <MessageCircle className="w-12 h-12 text-terracotta mx-auto mb-6" />
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg"
              className="bg-terracotta hover:bg-terracotta/90 text-white shadow-warm px-8 py-3"
              asChild
            >
            ...
            <Button 
              variant="outline"
              size="lg"
              className="border-earth-medium text-earth-medium hover:bg-earth-medium hover:text-white transition-all duration-300 px-8 py-3"
              asChild
            >
